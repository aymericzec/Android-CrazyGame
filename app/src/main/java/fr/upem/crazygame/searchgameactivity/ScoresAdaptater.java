...
public class ScoresAdaptater extends ArrayAdapter<Score> {

    private List<Score> scores;

    public ScoresAdaptater(@NonNull Context context, int resource, @NonNull List<Score> scores) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.row_layout_chat, parent, false);
        }
